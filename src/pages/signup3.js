                ...
                <>
                  ...
                  <Row gutter={[24, 0]}>
                    <Col xs={24} sm={24} md={24} lg={24} xl={24} style={{ margin: "0 0 50px 0" }}>
                      <div style={{ margin: "20px 0" }}>
                        ...
                        <Title level={2} style={{ color: "green", fontWeight: "700", margin: 0 }}>Home Improvments</Title>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", flexDirection: "column" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                      {!showManualEntry && <Title style={{ fontSize: "16px", margin: 0, color: "#4E4E4E" }}>Address 1 (no P.O. Box)</Title>}
                    </div>
